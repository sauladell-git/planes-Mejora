...
namespace TinyFileManager.NET
{
    ...
    public partial class dialog : System.Web.UI.Page
    {
        ...
        {
            if (!SessionHelper.IsAuthenticated || (SessionHelper.IsAuthenticated && !Roles.IsUserInRole(RoleConstants.ADMIN)))
                Response.Redirect("/");
            ...
            switch (strCmd)
            {
                ...
                default:    //just a regular page load
                    if (this.strCurrPath != "")
                    {
                        ...
                        this.objFItem.strDeleteLink = "<a class=\"btn erase-button top-right disabled\" title=\"Eliminar\"><i class=\"icon-trash\"></i></a>";
                    ...
                    foreach (string strF in arrFolders)
                    {
                        ...
                        {
                            this.objFItem.strDeleteLink = "<a href=\"" + this.strCurrLink + "&cmd=delfolder&folder=" + this.objFItem.strPath + "&currpath=" + this.strCurrPath + "\" class=\"btn erase-button top-right\" onclick=\"return confirm('¿Está seguro que desea eliminar la carpeta y todas las imágenes que contiene?');\" title=\"Eliminar\"><i class=\"icon-trash\"></i></a>";
                        }
                        else
                        {
                            this.objFItem.strDeleteLink = "<a class=\"btn erase-button top-right disabled\" title=\"Eliminar\"><i class=\"icon-trash\"></i></a>";
                    ...
                    foreach (string strF in arrFiles)
                    {
                        ...
                        if ((this.boolOnlyImage && this.objFItem.boolIsImage) || (this.boolOnlyVideo && this.objFItem.boolIsVideo) || (!this.boolOnlyImage && !this.boolOnlyVideo))
                        {
                            ...
                            {
                                this.objFItem.strDeleteLink = "<a href=\"" + this.strCurrLink + "&cmd=delfile&file=" + this.objFItem.strPath + "&currpath=" + this.strCurrPath + "\" class=\"btn erase-button\" onclick=\"return confirm('¿Está seguro que desea eliminar este archivo?');\" title=\"Eliminar\"><i class=\"icon-trash\"></i></a>";
                            }
                            else
                            {
                                this.objFItem.strDeleteLink = "<a class=\"btn erase-button disabled\" title=\"Eliminar\"><i class=\"icon-trash\"></i></a>";
                            }
                            // get thumbnail image
                            if (this.objFItem.boolIsImage)
                            {
                            ...
                            if (this.objFItem.boolIsImage)
                            {
                                this.objFItem.strPreviewLink = "<a class=\"btn preview\" title=\"Visualizar\" data-url=\"" + this.objConfig.strUploadURL + "/" + this.objFItem.strPath.Replace('\\', '/') + "\" data-toggle=\"lightbox\" href=\"#previewLightbox\"><i class=\"icon-eye-open\"></i></a>";
                            }
                            else
                            {
                                this.objFItem.strPreviewLink = "<a class=\"btn preview disabled\" title=\"Visualizar\"><i class=\"icon-eye-open\"></i></a>";
                            }
