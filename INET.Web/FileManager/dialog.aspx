...
<!----- uploader div start ------->
        <div class="uploader">            
	        ...
	        <center><button class="btn btn-large btn-primary close-uploader"><i class="icon-backward icon-white"></i> Regresar a la Lista de archivos</button></center>
...
<% if (this.objConfig.boolAllowUploadFile) { %>
                <button class="btn btn-primary upload-btn" style="margin-left:5px;"><i class="icon-upload icon-white"></i> Subir un archivo</button> 
<% } %>
<% if (this.objConfig.boolAllowCreateFolder)
   { %>
			    <button class="btn new-folder" style="margin-left:5px;"><i class="icon-folder-open"></i> Nueva Carpeta</button> 
<% } %>
                    ...
                    <%  
                        ...
                        foreach (TinyFileManager.NET.clsFileItem objF in this.arrLinks)
                        {
                            ...
                            else
                            {
                                ...
                                Response.Write("<button type=\"submit\" title=\"Descargar\" class=\"btn\"><i class=\"icon-download\"></i></button>");
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
		        ...
		        Dropzone.options.myAwesomeDropzone = {
		            //forceFallback: true,
		            dictInvalidFileType: "La extensión del archivo no está permitida",
                ...
                $('.new-folder').click(function(){
                    folder_name = window.prompt('Ingrese el nombre de la carpeta:', 'New Folder');
                    if(folder_name){
